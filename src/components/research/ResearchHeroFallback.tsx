      ...
      <div
        ...
        style={{
          background:
            ...
            "radial-gradient(ellipse 60% 22% at 50% 55%, rgba(217,164,65,0.5), rgba(194,94,76,0.35) 55%, transparent 75%), " +
            "radial-gradient(ellipse 70% 50% at 20% 10%, rgba(217,164,65,0.12), transparent 60%), " +
            "radial-gradient(ellipse 60% 45% at 85% 15%, rgba(194,94,76,0.14), transparent 60%)",
        }}
      />
      <div
