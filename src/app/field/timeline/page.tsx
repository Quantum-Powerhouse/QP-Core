...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    "When will useful quantum computers arrive? Hartmut Neven, IBM, Scott Aaronson vs Jensen Huang, Gil Kalai, Sankar Das Sarma — real quotes with dates and sources, and an honest account of how lopsided the evidence has become.",
  path: "/field/timeline",
