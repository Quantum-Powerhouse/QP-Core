...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    "The quantum technology already in products: JILA's strontium clock at 8.1 × 10⁻¹⁹ systematic uncertainty, two-minute atomic coherence with 1.5 × 10⁻¹⁸ instability at one second, and an honest readiness picture for clocks versus gravimeters.",
  path: "/field/sensing",
