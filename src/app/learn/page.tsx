...
const LEVELS: { level: string; title: string; goal: string; steps: { game: string; slug: string; learn: string }[] }[] = [
  {
    ...
    steps: [
      ...
      { game: "π-Pulse Trainer", slug: "pi-pulse-trainer", learn: "How a NOT gate is really made — calibration, not magic." },
      { game: "Born Casino", slug: "born-casino", learn: "Probability is fundamental here. Try to beat it; you can't, and that's the lesson." },
      { game: "Measurement Duel", slug: "measurement-duel", learn: "The same state answers Z and X differently. Complementarity, felt." },
  ...
  },
  {
    ...
    steps: [
      { game: "Interference Lab", slug: "interference-lab", learn: "Two paths, one phase knob, certainty to impossibility. Every algorithm is this." },
  ...
  {
    level: "Level 4",
    title: "Algorithms, noise, and the fight for survival",
    goal: "Run the famous algorithms and meet the enemy every quantum computer fights.",
    steps: [
