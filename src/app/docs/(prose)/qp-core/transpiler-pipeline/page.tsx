...
export default function TranspilerPipelineDocPage() {
  ...
  return (
    <>
      ...
      <P>
        The{" "}
        <SourceLink href="/playground/qp-core">live playground on this site</SourceLink> shows a small, honest
      ...
      <P>
        ...
        ) covers correctness — a health check and a Bell-state transpile that asserts the reported qubit count —
        not performance. There is no Rust or native extension anywhere in this service; it is pure Python
