...
const RELEASE = "https://github.com/sadeqisaidmohaddes-star/quantum-cicd-research/releases/tag/v1.1.0";
const PDF = "https://github.com/sadeqisaidmohaddes-star/quantum-cicd-research/releases/download/v1.1.0/quantum-cicd-gap-study.pdf";
...
const BIBTEX = `@misc{sadeqi2026quantumcicd,
  ...
  month        = aug,
  version      = {1.1},
  howpublished = {Research record and paper, GitHub release v1.1.0},
  url          = {${RELEASE}},
...
export default function PaperPage() {
  ...
  return (
    <>
      ...
      <p className="mt-2 font-mono text-sm text-muted">A primary-source-verified prior-art study · Said Mohaddes Sadeqi · v1.1, August 2026</p>

      <div className="mt-6 flex flex-wrap gap-3">
        <a href={PDF} className="rounded-full bg-accent px-4 py-2 font-mono text-xs font-semibold text-[#041014]" target="_blank" rel="noopener noreferrer">
          PDF (GitHub release v1.1.0) ↗
        </a>
      ...
      <section className="glass-panel mt-8 rounded-xl p-5">
        ...
        <p className="mt-3 text-sm leading-relaxed text-muted">
          ...
          Starting from a hypothesis that none did, {stats.totalClaims} claims were checked against primary sources —
          official repositories, raw CI configurations, arXiv full texts and DOI records — that were opened and
      ...
      <div className="mt-6 grid gap-5 md:grid-cols-2">
        ...
        <section className="glass-panel rounded-xl p-5">
          <h2 className="font-mono text-xs uppercase tracking-widest text-accent">Archival status — stated plainly</h2>
      ...
      <section className="glass-panel mt-6 rounded-xl p-5">
        ...
        <p className="mt-3 text-sm leading-relaxed text-muted">
          The PDF is rendered from the research record, not written separately — the{" "}
