...
export const metadata: Metadata = buildMetadata({
  ...
  description: "Our synthesis of what's genuinely novel in quantum CI/CD regression testing, what isn't, and the narrowest defensible research gap — built on the verified evidence, clearly marked as interpretation.",
...
export default function GapAnalysisPage() {
  return (
    <>
      ...
      <P>A genuine, active prior-art landscape exists across five layers:</P>
      ...
      <H2>11. What part of the proposed idea is genuinely novel, if any?</H2>
      ...
      <Note>
        ...
        framework for quantum software, packaged as reusable GitHub Actions tooling for third-party projects —
        using existing components (e.g. MQT QCEC as an equivalence-checking engine, Bugs4Q-style corpora as a
      ...
      <P>
        ...
        combination specifically. The state-aware/autonomous-agent angle remains genuinely open, but it is the
