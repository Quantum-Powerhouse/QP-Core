...
export const EVIDENCE: EvidenceRecord[] = [
  ...
  },
  {
    ...
    notes: "Absence of evidence after search, not proof of nonexistence.",
  },
  {
    claim:
    ...
    notes:
      "Explicitly marked NOT FOUND rather than FALSE, absence of evidence after a reasonably broad search, not proof of nonexistence. Least load bearing part of the original idea.",
  },
  {
    claimIds: ["C14"],
    claim:
